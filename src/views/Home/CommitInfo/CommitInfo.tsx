  ...
  return (
    <div className="mb-20 mt-32 flex w-full flex-wrap items-center justify-evenly gap-y-8 lg:mt-48">
      <div className="flex max-w-[340px] flex-col items-center justify-center space-y-6">
        ...
        <p className="text-center text-2xl font-semibold text-textColor">Pixel Perfect</p>
      ...
      <div className="flex max-w-[340px] flex-col items-center justify-center space-y-6">
        ...
        <p className="text-center text-2xl font-semibold text-textColor">High Quality</p>
        <p className="text-center text-base text-textSecondary">
          Most common methods for designing websites that work well on desktop is responsive and
          adaptive design.
        </p>
      </div>
      <div className="flex max-w-[340px] flex-col items-center justify-center space-y-4">
        <span className="relative inline-block">
