...
const CommitInfo = () => {
  ...
  const colorFill = theme === "dark" ? "#fff" : "#000";

  return (
    <div className="mb-20 mt-32 flex w-full flex-wrap items-center justify-evenly gap-y-8 lg:mt-48">
      <div className="flex max-w-[340px] flex-col items-center justify-center space-y-6">
        <span className="relative inline-block">
          ...
          <svg
            ...
            viewBox="0 0 512 512"
            width="112"
            className="absolute left-[50%] top-[50%] h-[60px] w-[60px] -translate-x-1/2 -translate-y-1/2 transform"
          >
            <g>
              <g fill="#ffbdbc">
        ...
        <p className="text-center text-2xl font-semibold text-textColor">Tiết kiệm</p>
        <p className="text-center text-base text-textSecondary">
          Ekila mang đến giải pháp tối ưu về chi phí, sử dụng nguồn lực hiệu quả và công nghệ tiên
          tiến để phát triển nhanh chóng. Với đội ngũ giàu kinh nghiệm, Ekila giúp khách hàng tiết
          kiệm chi phí dài hạn bằng các hệ thống bền vững và dễ dàng mở rộng về sau.
        </p>
      </div>
      <div className="flex max-w-[340px] flex-col items-center justify-center space-y-6">
        <span className="relative inline-block">
        ...
        <p className="text-center text-2xl font-semibold text-textColor">Sáng tạo</p>
        <p className="text-center text-base text-textSecondary">
          Ekila luôn tập trung vào sáng tạo và đổi mới, phát triển giải pháp độc đáo, cá nhân hóa để
          mang lại trải nghiệm tối ưu. Đội ngũ trẻ trung, năng động không ngừng nghiên cứu công nghệ
          mới, giúp khách hàng đi đầu và tiếp cận giải pháp đột phá, khác biệt.
        </p>
      </div>
      <div className="flex max-w-[340px] flex-col items-center justify-center space-y-6">
        <span className="relative inline-block">
        ...
        <p className="text-center text-2xl font-semibold text-textColor">Hiệu quả</p>
        <p className="text-center text-base text-textSecondary">
          Ekila cam kết mang lại kết quả rõ ràng, với quy trình làm việc khoa học và luôn chủ động
          cải tiến để tối ưu hóa hiệu suất. Đội ngũ Ekila không chỉ hoàn thành dự án đúng hạn mà còn
          đồng hành, hỗ trợ khách hàng lâu dài với chính sách hậu mãi rõ ràng.
        </p>
      </div>
    </div>
  );
